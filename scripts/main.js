...
// Her importerer vi vores store tekstblokke
import { introText, tutorialText, helpHTML } from './content.js';
...
function showTutorial() {
  openModal(tutorialText, `<button id="closeTut" class="modern-btn">Luk</button>`);
